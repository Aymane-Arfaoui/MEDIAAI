...
// MEDIAAI specific pages
const Overview = lazy(() => import('@/app/overview/page'))
const DashboardAnalytics = lazy(() => import('@/app/dashboard-analytics/page'))
const Analytics = lazy(() => import('@/app/analytics/page'))
const Knowledge = lazy(() => import('@/app/knowledge/page'))
const Strategy = lazy(() => import('@/app/strategy/page'))
const Planner = lazy(() => import('@/app/planner/page'))
const Agent = lazy(() => import('@/app/agent/page'))
const Repurpose = lazy(() => import('@/app/repurpose/page'))

// Legacy AI CEO pages
const Brief = lazy(() => import('@/app/brief/page'))
const Sources = lazy(() => import('@/app/sources/page'))
const SourceEmail = lazy(() => import('@/app/sources/email/page'))
const SourceCalendar = lazy(() => import('@/app/sources/calendar/page'))
const SourceNotes = lazy(() => import('@/app/sources/notes/page'))
const SourceQuickbooks = lazy(() => import('@/app/sources/quickbooks/page'))
const SourceBank = lazy(() => import('@/app/sources/bank/page'))
...
export const routes: RouteConfig[] = [
  ...
  {
    path: "/sources/quickbooks",
    element: <SourceQuickbooks />
  },
  {
    path: "/sources/bank",
    element: <SourceBank />
