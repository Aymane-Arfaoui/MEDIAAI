            ...
            <Card className="bg-primary/5 border-primary/20">
              ...
              <CardContent className="px-4 pb-3">
                <p className="text-xs text-muted-foreground">
                  This email discusses project updates and requests feedback on the proposal. Key points: timeline adjustment requested, budget review needed, stakeholder meeting scheduled for next week.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-primary/5 border-primary/20">
              ...
              <CardContent className="px-4 pb-3">
                <p className="text-sm text-muted-foreground mb-3 leading-relaxed">
                  "Thank you for the update. I've reviewed the timeline adjustments and they look reasonable. I'll prepare the budget analysis and share it before our stakeholder meeting. Let me know if you need anything else in the meantime."
                </p>
