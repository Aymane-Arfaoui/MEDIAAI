...
const footerLinks = {
  product: [
    { name: 'Daily Brief', href: '#features' },
    { name: 'Email Intelligence', href: '#features' },
    { name: 'Financial Oversight', href: '#features' },
    { name: 'AutoML', href: '#automl' },
  ],
  dataSources: [
    { name: 'Email', href: '#sources' },
    { name: 'Calendar', href: '#sources' },
    { name: 'QuickBooks', href: '#sources' },
    { name: 'Banking', href: '#sources' },
  ],
  deployment: [
    { name: 'Cloud', href: '#security' },
    { name: 'On-Premise', href: '#security' },
        ...
        <div className="grid gap-8 grid-cols-4 lg:grid-cols-6">
          ...
          <div className="col-span-4 lg:col-span-2 max-w-2xl">
            ...
            <p className="text-muted-foreground mb-6 max-lg:text-center max-lg:flex max-lg:justify-center">
              Executive intelligence system powered by LLMs. Centralize your business data, get daily briefs, and make informed decisions.
            </p>
