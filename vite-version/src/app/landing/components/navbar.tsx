...
import { Menu, ChevronDown, X, Moon, Sun, Brain } from 'lucide-react'
...
const navigationItems: { name: string; href: string; hasMegaMenu?: boolean }[] = [
  { name: 'Home', href: '#hero' },
  { name: 'How It Works', href: '#how-it-works' },
  { name: 'Features', href: '#features' },
  { name: 'Built For', href: '#for-who' },
  { name: 'FAQ', href: '#faq' },
...
const solutionsItems = [
  { title: 'Core Features' },
  { name: 'Daily Brief', href: '#daily-brief' },
  { name: 'Email Intelligence', href: '#email' },
  { name: 'Financial Oversight', href: '#financial' },
  { name: 'Ask AI CEO', href: '#ask' },
  { title: 'Data Sources' },
  { name: 'Email', href: '#email-source' },
  { name: 'Calendar', href: '#calendar-source' },
  { name: 'QuickBooks', href: '#quickbooks' },
  { name: 'Banking', href: '#banking' },
  { title: 'Deployment' },
  { name: 'Cloud', href: '#cloud' },
  { name: 'On-Premise', href: '#on-prem' },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between">
        ...
        <div className="hidden xl:flex items-center space-x-2">
          ...
          <Button variant="outline" asChild className="cursor-pointer">
            <a href={getAppUrl("/overview")}>
              <Brain className="h-4 w-4 mr-2" />
              Dashboard
            </a>
          </Button>
          <Button asChild className="cursor-pointer">
            <a href={getAppUrl("/overview")}>Get Started</a>
          </Button>
        </div>
            ...
            <div className="flex flex-col h-full">
              ...
              <SheetHeader className="space-y-0 p-4 pb-2 border-b">
                <div className="flex items-center gap-2">
                  ...
                  <SheetTitle className="text-lg font-semibold">MEDIAAI</SheetTitle>
